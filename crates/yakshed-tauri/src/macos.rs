...
use yakshed_desktop_api::{
    ...
    CredentialSlot, DesktopApi, FrontendEvent, FrontendRunSnapshot, OpenArtifactEnvelope,
...
command!(set_connection_credential(state; connection_id: ConnectionId, slot: CredentialSlot, value: String, overwrite: bool) -> SecretWriteEnvelope {
